...
config.placeholder = 'some value';
CKEDITOR.replace('tutorial', config);
...
$("#form_add").validate({
    ...
    submitHandler: function(form) {
        ...
        var tutorial = CKEDITOR.instances.tutorial.getData();
        $("#isi_tutorial").val(tutorial);
        $.ajax({ //line 28
            type: 'POST',
            url: '/post_payment_method',
            dataType: 'json',
            ...
            success: function(data) {
                ...
                CKEDITOR.instances.tutorial.setData(''); // ckeditor reset
            }
        });
    }
});
