        ...
        $.ajax({ //line 28
            ...
            success: function(data) {  
                ...
                if (data.code == 200) {
                    ...
                    location.reload('/penalty/category');
                } else {
...
function AddVoucher(){
    ...
    no = max + 1; 
    noms = "'"+no+"'";
    $("#body_voucher").append('<tr id="voucher_'+no+'" class="voucher" data-no="'+no+'"><td><input type="text" name="voucher[]" placeholder="" required></td><td><button type="button" class="btn btn-sm btn-danger" onclick="DelVoucher('+noms+')">Hapus</button></td></tr>');
}
