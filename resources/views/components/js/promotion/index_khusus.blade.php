...
function data_tabel(tabel) {
    ...
    if (tabel == 'data_promosi_khusus') {
        var xin_table = $('#data_tabel').DataTable({
            ...
            "bFilter": false,
            "ajax": {
                "url": '/data_promosi_khusus',
                "dataType": "json",
                "type": "POST",
                "data": { _token: "{{csrf_token()}}",tgl_start : tgl_start,tgl_end : tgl_end,status : status,search :search,sort:sort,tipe:tipe }
            },
            "columns": columns,
            "bDestroy": true
        });
...
$(function() {
    ...
    data_tabel('data_promosi_khusus')
});
