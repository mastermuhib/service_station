    ...
    if (tabel == 'data_complain') {
        var xin_table = $('#data_tabel').DataTable({
            ...
            "ajax": {
                ...
                "dataType": "json",
                "type": "POST",
                "data": { _token: "{{csrf_token()}}",tgl_start : tgl_start,tgl_end : tgl_end,id_shop : id_shop,search :search,sort:sort,status:status }
            },
            "columns": columns,
            "bDestroy": true
        });
