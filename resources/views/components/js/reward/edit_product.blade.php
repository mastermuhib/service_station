...
function AddVoucher(){
    ...
    no = max + 1; 
    noms = "'"+no+"'";
    $("#body_voucher").append('<tr id="voucher_'+no+'" class="voucher" data-no="'+no+'"><td><input type="text" name="voucher[]" placeholder="" required><input type="hidden" name="id_voucher[]" value=""></td><td></td><td><button type="button" class="btn btn-sm btn-danger" onclick="DelVoucher('+noms+')">Hapus</button></td></tr>');
}
