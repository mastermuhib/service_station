    ...
    <div class="card p-6 col-md-12">
        <div class="card-header" id="faqHeading2">
            <div class="card-title font-size-h4 text-dark collapsed" data-toggle="collapse" data-target="#faq2" aria-expanded="false" aria-controls="faq2" role="button">
                <div class="card-label">Filter <i class="fas fa-filter ml-10"></i></div>
            </div>
        </div>
        <!--end::Header-->
        <!--begin::Body-->
                ...
                <form id="form_filter">
                    <div class="row" data-select2-id="4">
                        <div class="col-md-3">
                            ...
                            <input type="date" name="tgl_start" class="form-control form-control-lg form-control form-control-lg-lg" onchange="data_tabel('data_saldo_history')" id="start">
                        </div>
                        <div class="col-md-3">
                            <label>Sampai Tanggal</label>
                            <input type="date" name="tgl_end" class="form-control form-control-lg form-control form-control-lg-lg" onchange="data_tabel('data_saldo_history')" id="end">
                        </div>
                        <div class="col-md-3">
                            <label>Status Saldo </label>
                            <select class="select2 form-control form-control-lg" id="status" name="status" onchange="data_tabel('data_saldo_history')">
    ...
    <div class="col-lg-12">
        ...
        <div class="card card-custom card-stretch gutter-b">
            ...
            <div class="card-header align-items-center border-0 row">
                <div class="col-md-2">
                    <h5 class="text-dark font-weight-bold ml-3"><spaan>Histori Saldo</spaan></h5> 
                </div>
                                            ...
                                            <div class="col-md-4 col-xs-12">
                                                <div class="mb-4">
                                                    <select class="form-control form-control-lg form-control form-control-lg-lg" onchange="data_tabel('data_transaksi_ppob')" id="sort" style="height: 45px;">
                                                        ...
                                                        <option value="1">Urutkan By Nama User</option>
                                                    </select>
                                                </div>
                                            </div> 
                                            <div class="col-md-6">
...
@include('components/js/transaksi/saldo_history')
@endsection