                ...
                <form id="form_filter">
                    <div class="row" data-select2-id="4">
                        <div class="col-md-3">
                            ...
                            <input type="date" name="tgl_start" class="form-control form-control-lg form-control form-control-lg-lg" onchange="data_tabel('data_transaksi_ads')" id="start">
                        </div>
                        <div class="col-md-3">
                            <label>Sampai Tanggal</label>
                            <input type="date" name="tgl_end" class="form-control form-control-lg form-control form-control-lg-lg" onchange="data_tabel('data_transaksi_ads')" id="end">
                        </div>
                        <div class="col-md-3">
                            <label>Status Transaksi </label>
                            <select class="select2 form-control form-control-lg" id="status" name="status" onchange="data_tabel('data_transaksi_ads')">
                        ...
                        <div class="col-md-3">
                            <label>Iklan </label>
                            <select class="select2 form-control form-control-lg" id="id_ads" name="id_category" onchange="data_tabel('data_transaksi_ads')">
                                <option value="">Semua</option>
                                @foreach($ads as $c)
    ...
    <div class="col-lg-12">
        ...
        <div class="card card-custom card-stretch gutter-b">
            ...
            <div class="card-header align-items-center border-0 row">
                <div class="col-md-2">
                    <h5 class="text-dark font-weight-bold ml-3"><spaan>List Transaksi Iklan</spaan></h5> 
                </div>
                                    ...
                                    <div class="card-body card-dashboard">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-xs-12">
                                                <div class="mb-4">
                                                    <select class="form-control form-control-lg form-control form-control-lg-lg" onchange="data_tabel('data_transaksi_ads')" id="sort" style="height: 45px;">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group rounded bg-light">
                                                    ...
                                                    <input type="text" id="s_search" class="form-control form-control-lg h-45px" onkeyup="data_tabel('data_transaksi_ads')" placeholder="Cari by Invoice/Customer/Gerai">
                                                </div>
                                            </div>
                                        </div>
...
@include('components/js/transaksi/index_ads')
@endsection