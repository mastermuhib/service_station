    ...
    <div class="card p-6 col-md-12">
        <div class="card-header" id="faqHeading2">
            <div class="card-title font-size-h4 text-dark collapsed" data-toggle="collapse" data-target="#faq2" aria-expanded="false" aria-controls="faq2" role="button">
                <div class="card-label">Filter Refund<i class="fas fa-filter ml-10"></i></div>
            </div>
        </div>
        <!--end::Header-->
        <!--begin::Body-->
                ...
                <form id="form_filter">
                    <div class="row" data-select2-id="4">
                        <div class="col-md-4">
                            ...
                            <input type="date" name="tgl_start" class="form-control form-control-lg form-control form-control-lg-lg" onchange="data_tabel('data_transaksi_refund')" id="start">
                        </div>
                        <div class="col-md-4">
                            <label>Sampai Tanggal</label>
                            <input type="date" name="tgl_end" class="form-control form-control-lg form-control form-control-lg-lg" onchange="data_tabel('data_transaksi_refund')" id="end">
                        </div>
                        <div class="col-md-4">
                            <label>Tipe Transaksi </label>
                            <select class="select2 form-control form-control-lg" id="type" name="type" onchange="data_tabel('data_transaksi_ppob')">
                                <option value="">Semua</option>
                                <option value="1">Transaksi Produk</option>
                                <option value="3">Transaksi Jasa</option>
                                <option value="2">Transaksi PPOB</option>
                            </select>
                        </div>
    ...
    <div class="col-lg-12">
        ...
        <div class="card card-custom card-stretch gutter-b">
            ...
            <div class="card-header align-items-center border-0 row">
                <div class="col-md-2">
                    <h5 class="text-dark font-weight-bold ml-3"><spaan>List Refund</spaan></h5> 
                </div>
...
@include('components/js/transaksi/index_refund')
@endsection