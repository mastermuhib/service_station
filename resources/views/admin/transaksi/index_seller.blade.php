                ...
                <form id="form_filter">
                    <div class="row" data-select2-id="4">
                        <div class="col-md-3">
                            ...
                            <input type="date" name="tgl_start" class="form-control form-control-lg form-control form-control-lg-lg" onchange="data_tabel('data_transaksi_seller')" id="start">
                        </div>
                        <div class="col-md-3">
                            <label>Sampai Tanggal</label>
                            <input type="date" name="tgl_end" class="form-control form-control-lg form-control form-control-lg-lg" onchange="data_tabel('data_transaksi_seller')" id="end">
                        </div>
                        <div class="col-md-3">
                            <label>Status Transaksi (disisi seller) </label>
                            <select class="select2 form-control form-control-lg" id="status_seller" name="status_seller" onchange="data_tabel('data_transaksi_seller')">
                                <option value="">Semua</option>
                                <option value="1">Pesanan Baru</option>
                                <option value="2">Siap Dikirim</option>
                                <option value="3">Dalam Pengiriman</option>
                                <option value="4">Dikomplain</option>
                                <option value="5">Tiba ditujuan</option>
                                <option value="6">Pesanan Selesai</option>
                                <option value="7">Batal</option>
                                <option value="8">sudah di beri rating/diberi ulasan</option>
                            </select>
                        </div>
                        <div class="col-md-3">
                            <label>Toko </label>
                            <select class="select2 form-control form-control-lg" id="id_shop" name="id_shop" onchange="data_tabel('data_transaksi_seller')">
                                <option value="">Semua</option>
                                @foreach($shop as $s)
    ...
    <div class="col-lg-12">
        ...
        <div class="card card-custom card-stretch gutter-b">
            ...
            <div class="card-header align-items-center border-0 row">
                <div class="col-md-2">
                    <h5 class="text-dark font-weight-bold ml-3"><spaan>List Transaksi</spaan></h5> 
                </div>
                <div class="col-md-6 pl-0">
                </div>
                <div class="col-md-4 d-none">
                    <a class="btn btn-primary font-weight-bolder" style="float: right;" id="tambah"><i class="fas fa-plus"></i> Add Promo</a>
                </div>
            </div>
            <!--end::Header-->
            <!--begin::Body-->
                                    ...
                                    <div class="card-body card-dashboard">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-xs-12">
                                                <div class="mb-4">
                                                    <select class="form-control form-control-lg form-control form-control-lg-lg" onchange="data_tabel('data_transaksi_seller')" id="sort" style="height: 45px;">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group rounded bg-light">
                                                    ...
                                                    <input type="text" id="s_search" class="form-control form-control-lg h-45px" placeholder="Cari by Invoice/Customer/Toko">
                                                </div>
                                            </div>
                                        </div>
...
@include('components/js/transaksi/index_seller')
@endsection