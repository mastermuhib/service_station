                ...
                <form id="form_filter">
                    <div class="row" data-select2-id="4">
                        <div class="col-md-3">
                            ...
                            <input type="date" name="tgl_start" class="form-control form-control-lg form-control form-control-lg-lg" onchange="data_tabel('data_transaksi')" id="start">
                        </div>
                        <div class="col-md-3">
                            <label>Sampai Tanggal</label>
                            <input type="date" name="tgl_end" class="form-control form-control-lg form-control form-control-lg-lg" onchange="data_tabel('data_transaksi')" id="end">
                        </div>
                        <div class="col-md-3">
                            <label>Status Transaksi (disisi seller) </label>
                            <select class="select2 form-control form-control-lg" id="status_seller" name="status_seller" onchange="data_tabel('data_transaksi')">
                                <option value="">Semua</option>
                                <option value="1">Pesanan Baru</option>
                                <option value="2">Siap Dikirim</option>
                                <option value="3">Dalam Pengiriman</option>
                                <option value="4">Tiba ditujuan</option>
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="select2 form-control form-control-lg" id="status_customer" name="status_customer" onchange="data_tabel('data_transaksi')">
                                <option value="">Semua</option>
                                ...
                                <option value="5">Dikomplain</option>
                                <option value="6">Tiba di tujuan</option>
    ...
    <div class="col-lg-12">
        ...
        <div class="card card-custom card-stretch gutter-b">
            ...
            <div class="card-header align-items-center border-0 row">
                <div class="col-md-2">
                    <h5 class="text-dark font-weight-bold ml-3"><spaan>List Promo</spaan></h5> 
                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group rounded bg-light">
                                                    ...
                                                    <input type="text" id="s_search" class="form-control form-control-lg h-45px" placeholder="Cari by Nama/Cabang/Harga">
                                                </div>
                                            </div>
                                        </div>
...
@include('components/js/transaksi/index')
@endsection